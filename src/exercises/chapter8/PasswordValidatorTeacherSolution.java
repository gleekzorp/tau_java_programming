...
public class PasswordValidatorTeacherSolution {
    ...
    public PasswordValidatorTeacherSolution(String username, String currentPassword){
    ...
    public static PasswordValidatorTeacherSolution login(){
        ...
        return new PasswordValidatorTeacherSolution(username, password);
    }
