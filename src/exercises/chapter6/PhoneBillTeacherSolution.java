...
public class PhoneBillTeacherSolution {
    ...
    public PhoneBillTeacherSolution(){
        id = 0;
        baseCost = 79.99;
        allottedMinutes = 800;
        minutesUsed = 800;
    ...
    public PhoneBillTeacherSolution(int id){
        this.id = id;
        baseCost = 79.99;
        allottedMinutes = 800;
        minutesUsed = 800;
    ...
    public PhoneBillTeacherSolution(int id, double baseCost, int allottedMinutes, int minutesUsed){
        this.id = id;
